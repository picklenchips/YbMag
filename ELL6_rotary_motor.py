...
def main() -> None:
    ...
    print("2. Jogging forward...")
    if motor.jog_forward():
        print("   ✓ Jog forward completed\n")
    else:
        print("   ✗ Jog forward failed\n")
    
    print("3. Jogging backward...")
    if motor.jog_backward():
        print("   ✓ Jog backward completed\n")
    else:
        print("   ✗ Jog backward failed\n")
